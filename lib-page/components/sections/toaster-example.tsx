...
import toast, { ToastPosition } from 'every-notify';
  ...
  const renderPosition = (p: ToastPosition) => (
    <button
      ...
      className={clsx(
        ...
        position === p
          ? 'bg-gradient-900 text-gradient-100 '
...
/>`}
      />
      <div className="order-first md:order-none col-span-2 grid grid-cols-3 justify-between bg-gradient-100 rounded-xl gap-x-2 gap-y-4 p-2 md:p-4">
